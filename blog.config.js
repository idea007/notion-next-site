...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion,博客,dafay,dafaycoding', // 网站关键词 英文逗号隔开
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-SF5ZRRNS85', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
