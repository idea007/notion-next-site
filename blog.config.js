...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '2ae8f6ca1d334829a8b75a554214834b',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Dafay', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '发现更大的世界', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.dafaycoding.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'idea00122@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  COMMENT_UTTERRANCES_REPO:
        process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'idea007/notion-next-site', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'idea007/notion-next-site', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  COMMENT_GITALK_REPO: process.env.NEXT_PUBLIC_COMMENT_GITALK_REPO || 'notion-next-site', // 你的Github仓库名，例如 'NotionNext'
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Dafay BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '发现更大的世界', // 站点描述，被notion中的页面描述覆盖
